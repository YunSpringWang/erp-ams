	...
	<form class="layui-form " action="">
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="paraCodeVague" placeholder="请输入名称"
					class="layui-input">
			</div>

			<div class="layui-input-inline">
				<button class="layui-btn search-btn" table-id="commparaTable"
	...
	<div class="layui-btn-group">
		...
		<shiro:hasPermission name="commpara:update">
			<button class="layui-btn"
				onclick="editPage('commparaTable','/commpara/edit')">
				<i class="fa fa-pencil-square-o">&nbsp;</i>修改
			</button>
			<button class="layui-btn layui-btn-green"
				onclick="updateState('批量启用','commparaTable','/commpara/enable')">
				<i class="fa fa-check-square-o">&nbsp;</i>启用
			</button>
			<button class="layui-btn  layui-btn-danger"
				onclick="updateState('批量禁用','commparaTable','/commpara/limit')">
				<i class="fa fa-expeditedssl">&nbsp;</i>禁用
			</button>
		</shiro:hasPermission>
		<shiro:hasPermission name="commpara:delete">
			<button class="layui-btn layui-btn-delete"
				onclick="deleteBatch('批量删除','commparaTable','/commpara/delete');">
		...
		<table class="layui-table" id="commparaTable" cyType="pageGrid"
			...
			<thead>
				<tr>
					...
					<!--isPrimary：是否是主键-->
					<th width="10%"
						param="{name:'paraId',isPrimary:'true',hide:'true'}">主键</th>
					...
					<!--isPrimary：渲染列-->
					<th width="10%"
						param="{name:'state',codeName:'state',render:'Render.customState'}">状态</th>
					<th width="10%"
						param="{operate:'true',buttons:'Render.state,Render.edit,Render.delete'}">操作</th>
				</tr>
			</thead>
		</table>
	</div>
