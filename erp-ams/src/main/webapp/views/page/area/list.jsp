	...
	<form class="layui-form " action="">
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="areaName" placeholder="请输入地区名称"
					class="layui-input">
			</div>
			<label class="layui-form-label">地区行政编码:</label>
			<div class="layui-input-inline">
				<input type="text" name="xzCode" placeholder="请输入地区行政编码"
					class="layui-input">
			</div>
			<label class="layui-form-label">状态:</label>
			<div class="layui-input-inline">
				<div cyType="selectTool" cyProps="codeName:'state'" name="state"
					class="layui-input-inline"></div>
			</div>
			<div class="layui-input-inline">
				<button class="layui-btn search-btn" table-id="AreaTable"
	...
	<div class="layui-btn-group">
		...
		<shiro:hasPermission name="area:delete">
			<button class="layui-btn"
				onclick="deleteBatch('AreaTable','/area/delete');">
		...
		<button class="layui-btn  layui-btn-danger"
			onclick="limit('AreaTable','/area/limit')">
		...
		<table class="layui-table" id="AreaTable" cyType="pageGrid"
			...
			<thead>
				<tr>
					...
					<!--isPrimary：是否是主键-->
					<th width="10%"
						param="{name:'areaId',isPrimary:'true',hide:'true'}"></th>
