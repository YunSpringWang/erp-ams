...
<title>登录</title>
<link rel="stylesheet"
	href="resources/plugins/layui/css/layui.css">
		...
		<div class="beg-login-main">
			<form class="layui-form">
				<div class="layui-form-item">
					...
					<input type="text" name="wLoginAccount"
						lay-verify="required|loginName" autocomplete="off"
						placeholder="账号/已认证邮箱" class="layui-input">
				</div>
				<div class="layui-form-item">
					<label class="login-icon"> <i class="layui-icon">&#xe642;</i>
					</label> <input type="password" name="wLoginPassword"
						lay-verify="required|password" autocomplete="off"
						placeholder="登陆密码" class="layui-input">
				</div>
				...
				<div class="layui-form-item">
					<button class="layui-btn btn-submit" lay-submit=""
						lay-filter="submitlogin">立即登录</button>
				</div>
				<div class="layui-form-item">
